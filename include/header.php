                    ...
                    <ul class="dropdown-menu category-dropdown-menu urja-subdropdown" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <li><a class="dropdown-item" href="honed-tubes-manufacturer">Honed Tubes Manufacturer</a></li>
                            ...
                            <li class="nav-item dropdown dropdown-with-icon-style02">
                                <div class="new-header-dd ">
                                    <!-- Products Link -->
                                    <a href="#" class="nav-link mb-0">Group Companies</a>
                                    <!-- Arrow Icon -->
                                    <a class="nav-link dropdown-toggle dropdown-toggle-split p-0 ms-2" href="#"
                                        id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu urja-subdropdown" aria-labelledby="navbarDropdownMenuLink">
                                        <li><a rel="nofollow" target="_blank"
                                                href="https://naraingroup.com/narain-co/">Narain & Co.</a></li>
                                        <li><a rel="nofollow" target="_blank"
                                                href="https://naraingroup.com/r-p-multimetals-ltd/">R.P Multimetals
                                                Ltd.</a>
                                        </li>
                                        <li><a rel="nofollow" target="_blank"
                                                href="https://naraingroup.com/r-p-concast/">R.P Concast</a></li>
                                        <li><a rel="nofollow" target="_blank"
                                                href="https://naraingroup.com/r-p-alloys-forging/">R.P Alloys &
                                                Forging</a>
                                        </li>
                                        <li><a rel="nofollow" target="_blank"
                                                href="https://naraingroup.com/r-p-multimetals-zinc-division/">R.P
                                                Multimetals
                                                Zinc Division</a>
                                        </li>
                                        <li><a rel="nofollow" target="_blank" href="https://rpengg.in/">RP
                                                Engineering</a></li>
                                        <li><a rel="nofollow" target="_blank"
                                                href="https://naraingroup.com/gold-homes/">Gold Homes</a></li>
                                    </ul>
                                </div>
                            </li>
