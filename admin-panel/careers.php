			  ...
			  <div class="modal-content">
				...
				<div class="view_internship_details">
					<div class="row">
						...
						<div class="col-2 label">Position Applying For:</div>
						<div class="col-1 label">:</div>
						<div class="col-3 value"><?php echo $row['position_applying_for']; ?></div>
						
						<div class="col-2 label">Resume:</div>
						<div class="col-1 label">:</div>
						<div class="col-8 value">
						<?php if(!empty($row['resume'])) {?>
						 <a target="_blank" href="../uploads/<?php echo $row['resume']; ?>"> <?php echo $row['resume']; ?> </a>
						<?php }?>
						...
						<div class="col-1 label">:</div>
						<div class="col-3 value"><?php echo $row['message']; ?></div>
