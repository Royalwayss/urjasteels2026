                    ...
                    <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block text-white fw-600 fs-18 ls-minus-05px mb-5px">Corporate Office
                                Address</span>
                            <p class="w-100 text-white">Narain and Company G.T. Road Mandi Gobindgarh Punjab.</p>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-01 mb-5 ">
                    <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block text-white fw-600 fs-18 ls-minus-05px mb-5px">Manufacturing Plant
                                Address</span>
                            <p class="w-100 text-white">RP Steel Tubes , Peer Gaju Shah Road , Badinpur Khanna Punjab, India
                                141401.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                        ...
                        <div class="feature-box-content">
                            ...
                            <div class="w-100 d-block text-white">
                                <a class="text-white" href="mailto:urjasteels@gmail.com">urjasteels@gmail.com</a><br />
                            </div>
                        </div>
                    </div>
                </div>
